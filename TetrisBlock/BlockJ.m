...
- (void)drawRect:(CGRect)rect {
    ...
    [self.square1 setColor:[UIColor blueColor]];
    [self.square2 setColor:[UIColor blueColor]];
    [self.square3 setColor:[UIColor blueColor]];
    [self.square4 setColor:[UIColor blueColor]];
