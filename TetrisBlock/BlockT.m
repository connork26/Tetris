...
- (void)drawRect:(CGRect)rect {
    ...
    CGRect frame2 = CGRectMake(origin.x + blockSize, origin.y, blockSize, blockSize);
    CGRect frame3 = CGRectMake(origin.x + blockSize * 2, origin.y, blockSize, blockSize);
    ...
    [self.square1 setColor:[UIColor purpleColor]];
    [self.square2 setColor:[UIColor purpleColor]];
    [self.square3 setColor:[UIColor purpleColor]];
    [self.square4 setColor:[UIColor purpleColor]];
