...
- (void)drawRect:(CGRect)rect {
    ...
    [self.square1 setColor:[UIColor redColor]];
    [self.square2 setColor:[UIColor redColor]];
    [self.square3 setColor:[UIColor redColor]];
    [self.square4 setColor:[UIColor redColor]];
